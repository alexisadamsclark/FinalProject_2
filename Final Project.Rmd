...
data <- Salaries
#there's no code for data import. 
...
plot3c <- data %>% 
  ...
  scale_y_continuous(breaks = c(0.25, 0.5, 0.75, 1.0),
                     ...
                     limits = c(0, 1.25)) +
  coord_flip()
ann_text<-data.frame(rank=c("Assistant Professor","Associate Professor","Full Professor","Assistant Professor","Associate Professor","Full Professor"),prop=c(1.10,1.10,1.10,1.10,1.10,1.10), discipline=c("Theoretical","Theoretical","Theoretical","Applied","Applied","Applied"),label=c("98.2%","84.8%", "90.8%", "99.4%", "97.8%", "98.7%"))
